            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-slate-800/30">
              <div className="bg-black p-8 group hover:bg-slate-950/50 transition-colors duration-300">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 flex-shrink-0 border border-slate-800 bg-slate-950/50 flex items-center justify-center group-hover:border-slate-700 transition-colors duration-300">
